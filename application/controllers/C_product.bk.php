...
class C_product extends CI_Controller {
    ...
    public function delete_image($id_media,$id_product){
        $where = array('id_media'=>$id_media);
        // var_dump($id_product);
        $this->M_product->pop_array($id_media,$id_product);
        $this->M_product->delete('media',$where);
        // $id_media['initialPreview'] = array();
        echo '{}';
    }
    //CRUD function
